...
Your goal here is pretty tangible: You have just embarked on a research cruise to [Rhode Island Sound](https://en.wikipedia.org/wiki/Rhode_Island_Sound) in June. We are going to use this paper as a tool to contextualize the environment we sampled.

Start with the abstract and introduction to give yourself a feel for what the paper is about and what context it fits into. Review the rest of the paper and answer the following as best you can. I've posted [example answers](https://classroom.google.com/c/NDg3ODE3MzU4NzEw/m/NTMyNzIwNTAwMzY0/details) to Google Classroom for you to compare to yours if you like:
