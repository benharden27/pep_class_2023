...
Your class project background presentation will be a group presentation of no longer than 2-3 minutes per group member and no longer than 10 mins in total. You should plan on discussing the following, not necessarily in this order in your presentation:
...
If you're new to these kinds of presentations that you'll find a basic template presentation in Google Classroom. There are four slides right now for you to fill in. Use the information you've gather from both your background oceanography levels and your annotated bibliography to bullet out some key points on the following ideas:
